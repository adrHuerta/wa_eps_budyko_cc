...
pisco_runoff["q_values_exp"] = pisco_runoff_values.loc["2000-12-31"].values # example to delete bad basins (is similar in all years)
...
new_pisco_runoff_values.to_csv("data/processed/present/PISCO/runoff/Q_mov30yearly.csv")
...
new_pisco_runoff.to_file("data/processed/present/PISCO/runoff/Q_mov30yearly_shp.shp")